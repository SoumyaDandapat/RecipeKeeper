...
class RemoteDataSource(private val context:Context,var mockFitEnable: Boolean = true) {
    ...
    private fun provideMockFitInterceptor(context: Context) = MockFitInterceptor(
        ...
        requestPathToJsonMap = REQUEST_TO_JSON, // (autogenerated constant, just press build button) made watching the sample code
    ...
    companion object {
        ...
        val REQUEST_TO_JSON: Map<String, String> = mapOf(
            "[GET] list" to "recipe_list.json"
        )
    }
}